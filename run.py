...
class Network(torch.nn.Module):
    def __init__(self):
        ...
        model_file_name = 'hed-' + arguments_strModel
        ...
        self.load_state_dict({ strKey.replace('module', 'net'): tenWeight for strKey, tenWeight in torch.hub.load_state_dict_from_url(url=url, file_name=model_file_name).items()})
    # end
...
def estimate(tenInput):
    ...
    # todo enable later, don't now why reshape to fixed w, h
...
if __name__ == '__main__':
    ...
    logger.info("input shape {}, \n input data {}", tenInput.shape, tenInput)
    tenOutput = estimate(tenInput)
    logger.info("output shape {}, \n output data {}", tenOutput.shape, tenOutput)
